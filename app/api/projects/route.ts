...
export async function GET(request: Request) {
    try {
        ...
        // We allow both authenticated access AND public access if portfolio is published?
        // Requirement says "Protect all /dashboard/* routes". API usually matches.
        // Public pages use server-side helper. So we can strictly protect API for dashboard.
